...
if(isset($_POST['submit'])){
    ...
    if(count($errors) === 0){
        ...
        $status = "0";
        $now = date('Y-m-d');
        $insert_data = "INSERT INTO registration (firstname, lastname, email, password, code, status, gender, created_on)
                        values(' $firstname','$lastname' , '$email', '$encpass', '$code', '$status', '$gender','$now')";
        ...
        if($data_check){
            ...
            $sender = "From:aocianews@gmail.com";
